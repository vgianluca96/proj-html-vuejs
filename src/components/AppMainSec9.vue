        ...
        <div class="container w-75">
            <div class="row justify-content-between align-items-center">
                <div class="col-2 position-relative">
                    ...
                    <input type="text" placeholder="1 Person" class="w-100 p-0">
                </div>
                <div class="col-1 text-uppercase text-center">
                    for
                </div>
                <div class="col-2 position-relative">
                    ...
                    <input type="text" placeholder="11/09/2020" class="w-100 p-0">
                </div>
                ...
                <div class="col-2 position-relative">
                    ...
                    <input type="text" placeholder="7:00 pm" class="w-100 p-0">
                </div>
                <div class="col-2">
